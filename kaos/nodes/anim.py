...
if TYPE_CHECKING:
    ...
    class hkaQuantizedAnimationNode(hkaAnimationNode):
        ...
        @overload
        def __getitem__(self, key: Literal["data"]) -> list[int]:...
        @overload
        ...
        @overload
        def __setitem__(self, key: Literal["data"], value: list[int]) -> None:...
        @overload
    ...
    class hkaInterleavedUncompressedAnimationNode(hkaAnimationNode):
        ...
        @overload
        def __getitem__(self, key: Literal["transforms"]) -> list[list[float]]:...
        @overload
        def __getitem__(self, key: Literal["floats"]) -> list[float]:...

        @overload
        def __setitem__(self, key: Literal["transforms"], value: list[list[float]]) -> None:...
        @overload
        def __setitem__(self, key: Literal["floats"], value: list[float]) -> None:...
